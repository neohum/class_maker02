        ...
        <div class="container">
            <div class="container">
                <div class="col items-center">
                    ...
                    --->
                    <a type="submit"
                        href="{{ route('last') }}/?school_name={{ $_REQUEST['school_name'] }}&current_grade={{ $_REQUEST['current_grade']}}&next_class={{ $_REQUEST['next_class'] }}"
                        class="btn btn-primary pull-left">5.데이터 삭제하기</a>
