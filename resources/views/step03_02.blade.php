        ...
        <div class="container">
            <div class="container">
                <div class="items-center col">
                    ...
                    <br>
                    <a type="submit"
                    href="{{ route('step03_02') }}/?school_name={{ $_REQUEST['school_name'] }}&current_grade={{ $_REQUEST['current_grade']}}&next_grade{{ $_REQUEST['next_grade'] }}&next_class={{ $_REQUEST['next_class'] }}"
